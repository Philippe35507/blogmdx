...
Dans l'exemple suivant, on va appliquer une ombre à un titre h1. La première valeur correspondra à la position horizontale de l’ombre tandis que la deuxième valeur fera varier la position verticale .
